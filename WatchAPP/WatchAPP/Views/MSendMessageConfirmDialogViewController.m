//
//  MSendMessageConfirmDialogViewController.m
//  WatchAPP
//
...
@interface MSendMessageConfirmDialogViewController ()

@end

@implementation MSendMessageConfirmDialogViewController
...
- (IBAction)didOnTextButtonTapped:(id)sender
{
    self.resultCode = 3;
    [self closePopView:sender];
}
