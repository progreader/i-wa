...
#define SV_IS_IOS7_OR_GREATER (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1)
...
- (void)updatePosition {
    ...
    if(string) {
        ...
        if (SV_IS_IOS7_OR_GREATER) {
            ...
            stringRect = CGRectMake(0, 0, 200, 60);
        }
