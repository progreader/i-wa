...
+ (Rule *)checkIfStringEquals:(NSString *)firstString secondString:(NSString *)secondString withFailureString:(NSString *)failureString forTextField:(UITextField *)textField;
