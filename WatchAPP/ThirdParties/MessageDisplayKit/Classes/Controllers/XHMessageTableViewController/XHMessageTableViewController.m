...
- (void)initilzer {
    ...
    inputView.isOnlyAllowVoiceInput = self.isOnlyAllowVoiceInput;
...
#pragma mp3 converter

- (void)toMp3:(NSString *)rawFilePath mp3FilePath:(NSString*)mp3FilePath
{
    @try {
        int read, write;
        FILE *pcm = fopen([rawFilePath cStringUsingEncoding:1], "rb");  //source
